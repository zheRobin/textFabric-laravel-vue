...
<template>
    <div>
        ...
        <Mentionable
            ...
            style="height: 100px"
        >
            <textarea @input="update" ref="textInput" :disabled="!canEdit" v-model="promptText" placeholder="Enter text and then type @ to trigger the attribute" rows="8" name="comment" id="comment" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-tf-blue-500 sm:text-sm sm:leading-6" />
            ...
            <template #item-@="{ item }" class="h-10" style="height: 100px;max-height: 100px">
