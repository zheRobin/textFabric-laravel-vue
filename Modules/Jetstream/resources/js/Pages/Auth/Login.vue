...
<template>
    <AuthLayout title="Sign in">
        <template #header>
            <h2 class="mt-6 text-3xl font-bold tracking-tight text-gray-900">{{ $t("Sign in to your account") }}</h2>
        ...
        <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    />
                    <InputLabel for="remember-me" :value="$t('Remember me')" class="ml-2 font-normal leading-5 text-gray-90" />
                </div>
