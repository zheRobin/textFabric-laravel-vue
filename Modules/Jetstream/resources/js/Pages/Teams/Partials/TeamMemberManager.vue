                    ...
                    <div v-if="availableRoles.length > 0" class="col-span-6 lg:col-span-4">
                        ...
                        <div class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer">
                            <button
                                ...
                                :key="role.key"
                                type="button"
                                class="relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-none focus:border-tf-blue-500 focus:ring-2 focus:ring-tf-blue-500"
                ...
                <template #content>
                    <div class="space-y-6">
                        <div v-for="user in team.users" :key="user.id" class="flex items-center justify-between">
                            <div class="flex items-center">
                                <img class="w-8 h-8 rounded-full" :src="user.profile_photo_url" :alt="user.first_name">
                                <div class="ml-4">
                                    {{ user.first_name }}
                                </div>
                            </div>
