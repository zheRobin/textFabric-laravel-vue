...
<template>
    <div class="text-sm flex  justify-between">
        ...
        <div>
            <button class="mr-2 custom-tooltip" v-if="activeCopyButton" :data-tooltip="copyStatus ? 'Copied!' : 'Click to copy'" @click="copy">
            ...
            <button type="button" @click="refreshApi" class="mr-4">
                <svg xmlns="http://www.w3.org/2000/svg" :class="loading ? 'animate-spin w-6 h-6' : 'w-6 h-6'" viewBox="0 0 20 20" fill="currentColor">
