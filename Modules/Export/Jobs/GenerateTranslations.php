...
class GenerateTranslations implements ShouldQueue
{
    ...
    public int $tries = 10; // The number of times the job may be attempted.
    ...
    public int $maxExceptions = 10; // The maximum number of unhandled exceptions to allow before failing.
